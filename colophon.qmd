...
The serif font is [***Playfair Display***](https://github.com/clauseggers/Playfair) (including its Smallcaps version), paired with the beautiful [Josefin Sans](https://fonts.google.com/specimen/Josefin+Sans).

The complete code as well as content for the website can be found on [GitHub](https://github.com/skriptum/quarto_site). I have added some extra tricks, but in the end its just some markdown files combined with graphic design inspired by the FT. 
