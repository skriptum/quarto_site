...
This website is built using [Quarto](https://quarto.org), a modern system to create Websites, Articles, PDFs or Presentations from [Markdown](https://de.wikipedia.org/wiki/Markdown). I created a custom *scss* theme to overcome the boring standard theme of quarto websites. The complete code as well as content for the website can be found on [GitHub](https://github.com/skriptum/quarto_site). I have added some extra tricks, but in the end its just some markdown files combined with graphic design (inspired by the FT btw). 
